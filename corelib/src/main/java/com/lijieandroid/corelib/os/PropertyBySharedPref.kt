 ...
 */
class PropertyBySharedPref<T>(context: Context = App.context, spName: String = "shared_pref", private val keyName: String = "", private val default: T) : ReadWriteProperty<Any, T> {
